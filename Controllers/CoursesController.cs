...
namespace Assignment1.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(GeorgianCollegeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CourseId,Name,DelieveryMode,Coordinator,Fees")] Courses courses)
        {
